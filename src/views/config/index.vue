							...
							<el-collapse v-model="activeNames">
								<el-collapse-item title="Basic" name="1">
									...
									<el-form-item label="Schedule period seconds" prop="ScheduleIntervalSeconds">
										<el-input-number v-model="form.ScheduleIntervalSeconds" />
									</el-form-item>
									...
									<el-form-item label="Disable exec user" prop="DisableExecUser">
										<el-switch v-model="form.DisableExecUser" active-text="Yes" :active-value="true"
								...
								<el-collapse-item title="Rest" name="2">
									<el-form-item label="Rest enabled" prop="REST.RestEnabled">
										<el-switch v-model="form.REST.RestEnabled" active-text="Yes" :active-value="true"
											inactive-text="No" :inactive-value="false" />
									</el-form-item>
									...
									<el-form-item label="Prometheus exporter listen port"
										prop="REST.PrometheusExporterListenPort">
										<el-input-number v-model="form.REST.PrometheusExporterListenPort" :min="0"
											:max="65534" />
									</el-form-item>
								...
								<el-collapse-item title="JWT" name="3">
									...
									<el-form-item label="JWT Interface" prop="REST.JWT.SecurityInterface">
										<el-select v-model="form.REST.JWT.SecurityInterface" placeholder="Please select">
											<el-option v-for="item in JWTOptions" :key="item.value" :label="item.label"
												:value="item.value" />
										</el-select>
									</el-form-item>
								</el-collapse-item>
								<el-collapse-item title="Consul" name="4">
									...
									<el-form-item label="Store user role in Consul" prop="Consul.EnableConsulSecurity">
										<el-switch v-model="form.Consul.EnableConsulSecurity" active-text="Yes"
											:active-value="true" inactive-text="No" :inactive-value="false" />
									</el-form-item>
