<template>
  <el-card class="box-card" v-if="record">
    <DescriptionList title="Basic information" col="12">
      ...
      <Description term="Add time">{{ record.register_time | formatEmpty }}</Description>
    ...
    <DescriptionList title col="12">
      ...
      <Description term="Period run interval(S)">{{ record.start_interval_seconds | formatEmpty }}</Description>
    ...
    <DescriptionList title="Runtime infomation" col="12">
      ...
      <Description term="CPU Usage">{{ record.cpu | formatMemory }}</Description>
      ...
      <Description term="Start number">{{ record.starts | formatEmpty }}</Description>
      <Description term="File descriptors">{{ record.fd | formatEmpty }}</Description>
