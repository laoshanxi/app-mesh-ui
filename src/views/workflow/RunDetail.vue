...
export default {
  ...
  computed: {
    ...
    // js-yaml is NOT a declared project dependency, so per the design we do NOT
    // parse workflow_get YAML for the DAG order here. Fallback: render jobs/steps
    // from the run_detail maps sorted by name, with no fabricated `needs` edges.
    orderedJobs() {
